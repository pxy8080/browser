...
private DrawerLayout drawerLayout;
    ...
    public NinjaWebView(Context context) {
        ...
        this.album = new AdapterTabs(this.context, this, browserController,null);
    ...
    public NinjaWebView(Context context,DrawerLayout drawerLayout) {
        super(context);
        sp = PreferenceManager.getDefaultSharedPreferences(context);
        String profile = sp.getString("profile", "standard");
        this.context = context;
        ...
        this.listStandard = new List_standard(this.context);
        this.listProtected = new List_protected(this.context);
        this.album = new AdapterTabs(this.context, this, browserController,drawerLayout);
        this.webViewClient = new NinjaWebViewClient(this);
        this.webChromeClient = new NinjaWebChromeClient(this);
        this.downloadListener = new NinjaDownloadListener(this.context);
    ...
    public synchronized void initCookieManager(String url) {
        ...
        } else manager.setAcceptCookie(true);
        profile = profileOriginal;
    }

    public void setProfileIcon(ImageView omniBox_tab) {
        ...
        switch (profile) {
            ...
            case "profileStandard":
                omniBox_tab.setImageResource(R.drawable.icon_multiwindow);
                break;
        ...
        else if (listStandard.isWhite(url)) omniBox_tab.setImageResource(R.drawable.icon_multiwindow);
    ...
    public void setProfileDefaultValues() {
        sp.edit()
                ...
                .putBoolean("profileProtected_dom", true).apply();
    }
