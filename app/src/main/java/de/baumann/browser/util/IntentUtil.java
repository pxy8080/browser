        ...
        if (extension != null) {
            ...
            if (type == null) {
                if ("m3u8".equals(extension)) {
                    //m3u8只是Unicode版本的m3u而已,目前(Android 1O)MimeTypeMap里没有m3u8对应的mimetype
...
//            Log.i("TAG", "openFileByUri: " + AUTHORITY_STRING);
//            Log.i("TAG", "openFileByUri2: " + file.getAbsolutePath());
//            Uri contentUri = FileProvider.getUriForFile(activityFrom.getApplicationContext(), AUTHORITY_STRING, file);
//            Log.d("TAG", "openFileByUri: contentURL:" + contentUri);
...
//        activityFrom.startActivity(intent);
        Log.i("TAG", "openFileByUri: 地址地址"+url);
